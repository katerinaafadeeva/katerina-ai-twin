...
- `.env.example` — added HH apply env vars with safe defaults

### New events

| Event | Actor | Payload |
|---|---|---|
| `apply.done` | `hh_apply_worker` | job_raw_id, action_id, apply_url |
| `apply.already_applied` | `hh_apply_worker` | job_raw_id, action_id, apply_url |
| `apply.manual_required` | `hh_apply_worker` | job_raw_id, action_id, apply_url |
| `apply.captcha` | `hh_apply_worker` | job_raw_id, action_id |
| `apply.session_expired` | `hh_apply_worker` | job_raw_id, action_id |
| `apply.failed` | `hh_apply_worker` | job_raw_id, action_id, error |
| `apply.cap_reached` | `hh_apply_worker` | cap, today |
